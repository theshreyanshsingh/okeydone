...
const Navigation = ({ noLogo = false, theme = false }) => {
  ...
  useEffect(() => {
    scrollPosition > 20 ? setStatus(false) : setStatus(true);
  }, [scrollPosition]);
          ...
          <div className="row menupage-mobile">
            <div className="col-5 col-sm-12">
              <div className="menupage-contact">
                <h2>Get In Touch</h2>
                <a
                  aria-label="contact@okaydone.in"
                  href="mailto:contact@okaydone.in"
                  className="menupage-contact-link"
                >
                  contact@okaydone.in
                </a>
                <a
                  aria-label="contact@okaydone.in"
                  href="mailto:careers@okaydone.in"
                  className="menupage-contact-link"
                >
                  careers@okaydone.in
                </a>
                <a
                  aria-label="+91 98860 98992"
                  href="tel:+91 98860 98992"
                  className="menupage-contact-link"
                >
                  +91 98860 98992
                </a>
                ...
                {menuOpen && (
                  <ul>
                    ...
                    >
                      <Link
                        href="/solutions"
                        className="navbar-menu-links-link"
                      >
                        <motion.div
                        ...
                        {activeLink === "one" && (
                          <div key="middle-line1" className="middle-line one">
                    ...
                    >
                      <Link href="/work" className="navbar-menu-links-link">
                        ...
                        {activeLink === "two" && (
                          <div key="middle-line1" className="middle-line two">
                            <div className="middle-line-teal" />
                            <div className="middle-line-purple" />
                          </div>
                        )}
                    ...
                    >
                      <Link href="/careers" className="navbar-menu-links-link">
                        ...
                        {activeLink === "three" && (
                          <div key="middle-line1" className="middle-line three">
                            <div className="middle-line-teal" />
                            <div className="middle-line-purple" />
                          </div>
                        )}
                    ...
                    >
                      ...
                      >
                        ...
                        {activeLink === "four" && (
                          <div key="middle-line1" className="middle-line four">
                            <div className="middle-line-teal" />
                            <div className="middle-line-purple" />
                          </div>
                        )}
